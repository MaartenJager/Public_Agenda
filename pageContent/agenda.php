                ...
                <div id="agenda">
                    <?php
                        ...
                        while($row = $sth->fetch()) {
                            ...
                            echo(" <a href=\"#" . $row->id . "\" onclick=\"expandEntry('" . $row->id . "');\" itemprop=\"url\"><span class=\"summary\" itemprop=\"summary\">". $row->title ."</span></a> <a href=\"index.php?page=event-review&id=" . $row->id . "\"> <img src="img/btn-edit.png" title="Aanpassen" alt="Aanpassen"> </a>\n");
