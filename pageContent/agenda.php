                ...
                <div id="agenda">
                    <?php
                        ...
                        while($row = $sth->fetch()) {                          
                            ...
                            if ($counter % 2)
                                echo("  <div id=\" class=\"odd\" itemscope itemtype=\"http://data-vocabulary.org/Event\">\n");
                            else
                                echo("  <div id=\" class=\"even\" itemscope itemtype=\"http://data-vocabulary.org/Event\">\n");
                            echo("    <div class=\"date\">\n");
                            echo("              <div class=\"day\">" . date("d", $row->beginDate) . "</div>\n");
                            echo("            <div class=\"month\">" . date("F", $row->beginDate) . "</div>\n");
                            echo("        </div>\n");
                            echo "        <div class=\"comment\">\n" ;
                            echo "            <a href=\"#" . $row->id . "\" onclick=\"expandEntry('" . $row->id . "');\" itemprop=\"url\"><span class=\"summary\" itemprop=\"summary\">". $row->title ."</span></a> <a href=\"index.php?page=event-review&id=" . $row->id . "\">Edit</a>\n" ;
