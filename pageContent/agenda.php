                ...
                <div id="agenda">
                    <?php
                        ...
                        while($row = $sth->fetch()) {
                            ...
                            echo "                        <div class=\"title\"><a href=\"#" . $row->id . "\" onclick=\"expandEntry('" . $row->id . "');\" itemprop=\"url\"><span class=\"summary\" itemprop=\"summary\">". $row->title ."</span></a></div>";
                            echo "                            <a href=\"index.php?page=event-review&id=" . $row->id . "\"> <img id=\"btn-icon\" src=\"img/btn-edit.png\" title=\"Aanpassen\" alt=\"Aanpassen\" width=\"16\" height=\"16\"></a>\n";
